...
void MainWindow::Initialize()
{
    ...
    setStyleSheet("QMainWindow { background-image: url(D:/TicTacBoom-git/TicTacToe_Game/Qt_2/00_Main_Menu.png); background-position: center; background-repeat: repeat; }");
